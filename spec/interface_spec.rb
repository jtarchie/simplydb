...
describe SimplyDB::Interface do
  ...
  describe "successful API calls" do
    it "should set stats for a request" do
      ...
      with(:body => 'Action=DeleteDomain&DomainName=MyDomain&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=Kt8H72qUjUZah09u9PB3BiRP8vgbfXQIa44bsJYofXo%3D').
    ...
    describe "for attribute actions" do
      describe "#get_attributes" do
        it "should get attributes from an item" do
          stub_request(:post, "https://sdb.amazonaws.com/").
          with(:body => "Action=GetAttributes&DomainName=MyDomain&ItemName=Item123&ConsistentRead=false&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=5WfM4sn0VhO9e4CPp4ro6p94YvMLngh9m4GD0Ta0%2F7Y%3D").
        ...
        it "should only get specific attributes" do
          stub_request(:post, "https://sdb.amazonaws.com/").
          with(:body => "Action=GetAttributes&DomainName=MyDomain&ItemName=Item123&ConsistentRead=false&AttributeName.0=Color&AttributeName.1=Size&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=%2BgO%2Fh7Ix7gkRO0u%2B9t%2BpOrQNldCslyItZm0EY%2F7Nz7g%3D").
      ...
      it "should set a batch of attributes for items" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => 'DomainName=MyDomain&ActionName=BatchPutAttributes&Item.0.ItemName=Shirt1&Item.0.Attribute.0.Name=Color&Item.0.Attribute.0.Value[]=Blue&Item.0.Attribute.1.Name=Size&Item.0.Attribute.1.Value[]=Med&Item.0.Attribute.2.Name=Price&Item.0.Attribute.2.Value[]=0014.99&Item.1.ItemName=Shirt2&Item.1.Attribute.0.Name=Color&Item.1.Attribute.0.Value[]=Red&Item.1.Attribute.1.Name=Size&Item.1.Attribute.1.Value[]=Large&Item.1.Attribute.2.Name=Price&Item.1.Attribute.2.Value[]=0019.99&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=OBFIXo9NtwrP6Osc0FjNtLU8t1Z0z2NAc%2FloLvdb5sk%3D').
      ...
      it "should be able to perform a select query" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => 'Action=Select&SelectExpression=select%20Color%20from%20MyDomain%20where%20Color%20like%20\'Blue%25\'&ConsistentRead=false&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=o%2BGcUfU%2BGkNpiAuibSfNnMyYQ2zENrqqCtRcDRW9cZo%3D').
      ...
      it "should delete attributes from an item" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => "Attribute.0.Name=color&Attribute.0.Value=red&Attribute.1.Name=color&Attribute.1.Value=brick&Attribute.2.Name=color&Attribute.2.Value=garnet&DomainName=MyDomain&ItemName=JumboFez&Action=DeleteAttributes&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=y0TiZtiCw43FcSq6gS6WzhEIgBELLm9zzX7dlNYlQn4%3D").
      ...
      it "should be able to put attribues on an item" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => "Attribute.0.Name=color&Attribute.0.Value=red&Attribute.1.Name=color&Attribute.1.Value=brick&Attribute.2.Name=color&Attribute.2.Value=garnet&DomainName=MyDomain&ItemName=Item123&Action=PutAttributes&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=mTCSIWRwZiOY%2BeXLMdp9962OCSwf6Z0slBzG2caFGBM%3D").
    ...
    describe "for domain actions" do
      it "should be able to create a domain" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => "Action=CreateDomain&DomainName=MyDomain&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=0Fwo7xWpFycQe1UHhGG4gXIZPPhtBLzTPRh7S4fzD%2BY%3D").
      ...
      it "should be able to list domains" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => "Action=ListDomains&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=w2JjcUfj59tQ%2FmCyYPKDAviOaXg6WLP2Yt%2Ft9xeoTVw%3D").
      ...
      it "should be able to get the metadeta for a domain" do
        stub_request(:post, "https://sdb.amazonaws.com/").
        with(:body => "Action=DomainMetadata&DomainName=Test&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=ds9yJy3XI8FtUmk10LoqBs%2BqDCPAS%2FWpgjvtrWe%2BdYA%3D").
