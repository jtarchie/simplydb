...
describe SimplyDB::Client do
  ...
  describe "#call" do
    it "should be able to make an HTTP POST request" do
      ...
      with(:body => %r{name=John&AWSAccessKeyId=12345&SignatureVersion=2&Timestamp=2011-04-11T23%3A09%3A00-07%3A00&Version=2009-04-15&SignatureMethod=HmacSHA256&Signature=1ds5YhHNymdgKTWOC0fjQ1YZlpBC%2FEh2K%2FbwE76auGI%3D}).
